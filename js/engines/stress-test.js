...
const SCENARIOS = {
  covid_2020: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.10, "Comunicações": -0.20
    },
    defaultDrop: -0.34
  },
  gfc_2008: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.30, "Comunicações": -0.40
    },
    defaultDrop: -0.56
  },
  dotcom_2000: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.10, "Comunicações": -0.60
    },
    defaultDrop: -0.49
  },
  rate_hike_2022: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.25, "Comunicações": -0.30
    },
    defaultDrop: -0.24
  },
  tech_bear: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.05, "Comunicações": -0.35
    },
    defaultDrop: -0.25
  },
  energy_crisis: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.12, "Comunicações": -0.12
    },
    defaultDrop: -0.20
  },
  global_recession: {
    ...
    sectorDrops: {
      ...
      "Utilidades": -0.20, "Comunicações": -0.35
    },
    defaultDrop: -0.40
  }
};
